...
/////////////////////////////////////////////////////////////////////////////
// CCWAnnotations properties

short CCWAnnotations::GetCount()
{
	short result;
...
void CCWAnnotations::SetCount(short propVal)
{
	SetProperty(0x100, VT_I2, propVal);
}

/////////////////////////////////////////////////////////////////////////////
// CCWAnnotations operations

CCWAnnotation CCWAnnotations::Item(const VARIANT& Item)
{
...
LPUNKNOWN CCWAnnotations::_NewEnum()
{
	LPUNKNOWN result;
...
void CCWAnnotations::Remove(const VARIANT& Element)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
void CCWAnnotations::RemoveAll()
{
	InvokeHelper(0x103, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

CCWAnnotation CCWAnnotations::Add()
{
	LPDISPATCH pDispatch;
